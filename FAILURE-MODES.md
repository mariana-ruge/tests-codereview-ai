# Catálogo de Modos de Falla: [amounts.py](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py)

Este documento detalla el análisis de modos de falla del módulo de montos, clasificados en cuatro categorías: **Null/Vacío**, **Frontera**, **Equivalencia** y **Contrato de Negocio**.

---

## 1. Null / Vacío

### FM-NULL-01: Entrada nula en [parse_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L31)
- **ID**: FM-NULL-01
- **Categoría**: Null/vacío
- **Riesgo**: Caída del flujo de ejecución en capas superiores por excepciones no controladas si no se captura [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23).
- **Entrada que lo dispara**: `raw = None`
- **Comportamiento actual observado en el código**: Lanza [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con el mensaje `"amount is required"`.
- **Contrato esperado recomendado**: Lanzar [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) indicando la ausencia del parámetro.
...
### FM-NULL-02: String vacío o espacios en blanco en [parse_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L31)
- **ID**: FM-NULL-02
- **Categoría**: Null/vacío
...
- **Comportamiento actual observado en el código**: Lanza [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con el mensaje `"amount must be numeric"` (debido a que `Decimal("")` lanza `InvalidOperation`, atrapada en la línea 37).
- **Contrato esperado recomendado**: Debería lanzar [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con el mensaje `"amount is required"` o `"amount cannot be empty"`.
...
### FM-NULL-03: Moneda nula en [normalize_currency](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L46)
- **ID**: FM-NULL-03
- **Categoría**: Null/vacío
...
- **Comportamiento actual observado en el código**: Lanza [CurrencyError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L27) con el mensaje `"currency is required"`.
- **Contrato esperado recomendado**: Lanzar [CurrencyError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L27) indicando que la moneda es obligatoria.
- **Estado del contrato**: confirmado
...
### FM-NULL-04: Moneda vacía o con espacios en blanco en [normalize_currency](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L46)
- **ID**: FM-NULL-04
- **Categoría**: Null/vacío
...
### FM-FRONT-01: Monto negativo en [validate_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L60)
- **ID**: FM-FRONT-01
- **Categoría**: Frontera
...
- **Comportamiento actual observado en el código**: Lanza [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con el mensaje `"amount cannot be negative"`.
...
### FM-FRONT-02: Límite máximo en [validate_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L60)
- **ID**: FM-FRONT-02
- **Categoría**: Frontera
...
- **Comportamiento actual observado en el código**: Lanza [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con el mensaje `"amount exceeds maximum allowed"`.
...
### FM-FRONT-03: Descontinuidad y comportamiento del límite de cero en [calculate_fee](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L72)
- **ID**: FM-FRONT-03
- **Categoría**: Frontera
...
- **Contrato esperado recomendado**: Decidir formalmente si un monto de cobro igual a cero es permitido en el sistema de pagos. Si es inválido, [validate_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L60) debe exigir `amount > 0`. Si es permitido para simulaciones o verificaciones de tarjeta, se debe definir si la comisión debe ser cero o la mínima.
- **Estado del contrato**: pendiente de decisión
...
### FM-FRONT-04: Valores no finitos (`NaN`, `Infinity`) en [parse_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L31)
- **ID**: FM-FRONT-04
- **Categoría**: Frontera
...
- **Comportamiento actual observado en el código**: Lanza [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con el mensaje `"amount must be finite"`.
...
### FM-FRONT-05: Redondeo en la frontera media (`ROUND_HALF_EVEN`) en [round_money](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L68)
- **ID**: FM-FRONT-05
- **Categoría**: Frontera
...
### FM-EQUIV-01: Pérdida de precisión al inicializar desde tipo float en [parse_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L31)
- **ID**: FM-EQUIV-01
...
- **Comportamiento actual observado en el código**: Lanza [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con `"amount must be numeric"` para cualquier string que contenga separadores que la clase `Decimal` no admita de forma nativa.
...
### FM-EQUIV-03: Tipo de datos no soportados en [parse_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L31)
- **ID**: FM-EQUIV-03
- **Categoría**: Equivalencia
- **Riesgo**: Lanzamiento de excepciones genéricas o comportamientos indefinidos ante payloads corruptos.
- **Entrada que lo dispara**: `raw = []` o `raw = {}`
- **Comportamiento actual observado en el código**: Lanza [AmountError](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L23) con el mensaje `"amount must be numeric"`.
...
### FM-EQUIV-04: Robustez en la normalización de la moneda en [normalize_currency](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L46)
- **ID**: FM-EQUIV-04
- **Categoría**: Equivalencia
...
### FM-BIZ-01: Límite máximo estático global para múltiples divisas en [validate_amount](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L60)
- **ID**: FM-BIZ-01
...
### FM-BIZ-02: Límite de monto máximo respecto a la tarifa total en [total_with_fee](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L84)
- **ID**: FM-BIZ-02
- **Categoría**: Contrato de negocio
...
- **Comportamiento actual observado en el código**:
  - [calculate_fee](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L72) hace `round_money(fee)`.
  - [total_with_fee](file:///C:/Users/jsrso/projects/Platzi/Pruebas%20IA/payments-svc/src/payments_svc/amounts.py#L84) hace `round_money(amount + calculate_fee(amount, currency))`.
